...
ggplot(data = data, aes(x = distance, y = std_residuals)) +
  geom_point() +
  labs(title = "Standardized Residuals by Fitted Value", x = "Distance", y = "Standardized Residuals")
```
...
ggplot(data = data, aes(x = as.numeric(psi), y = std_residuals)) +
  ...
  labs(title = "Standardized Residuals by PSI", x = "PSI", y = "Standardized Residuals")
```
...
ggplot(data = data, aes(x = as.numeric(angle), y = std_residuals)) +
  ...
  labs(title = "Standardized Residuals by Angle", x = "Angle", y = "Standardized Residuals")
```
...
ggplot(data = data, aes(x = std_residuals)) +
  geom_histogram(bins = 15, fill = "steelblue", color = "black") +
  labs(title = "Standardized Residuals by Frequency", x = "Standardized Residuals", y = "Frequency")
```
...
ggplot(data = data, aes(x = seq_along(std_residuals), y = std_residuals)) +
  geom_point() +
  labs(title = "Standardized Residuals by Order", x = "Order of Observations", y = "Standardized Residuals")
```
